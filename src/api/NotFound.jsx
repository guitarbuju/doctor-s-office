...
const NotFound = () => {
  return (
    ...
    <div className="bg-white border border-gray-200 flex flex-col items-center justify-center px-4 md:px-8 lg:px-24 py-8 rounded-lg shadow-2xl">
        ...
        <Link to='/' className="flex items-center space-x-2 bg-medBlue hover:bg-purple-400 text-gray-100 px-4 py-2 mt-6 rounded transition duration-150" title="Return Home">
