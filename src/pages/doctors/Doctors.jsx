...
const onSubmit = async (data) => {
  console.log(data)
  try {
    const recordDoctorToApi = await postPersonData(url,data);
  ...
  return (
    ...
    <span className="block mb-2 ">EASYMED Patient Management System</span>
       <h1 className="text-5xl font-extrabold ">Doctor&apos;s <br/> Register Form</h1>
    <img src="https://www.vinci.com/vinci/actualites-v3.nsf/B031ABB656909551C1257A7900424A73/$file/Hopital_Varsovie-hd.jpg" alt="" className="object-cover w-full h-[650px] rounded-md xl:col-span-3" />
    </article>
