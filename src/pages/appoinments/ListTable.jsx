...
const ListTable = ({appointmentList, reloadAppointmentList}) => {
  ...
  return (
    ...
    <div className="container p-2 mx-auto sm:p-4 text-gray-900">
     <h2 className="mb-4 text-2xl font-semibold leading-tight text-gray-900">Appointments</h2>
         ...
         <table className="w-full p-6 text-xs text-left whitespace-nowrap">
             ...
             <thead>
                 <tr className=" text-lg ">
                     ...
                     <th className="p-3 flex align-middle justify-center">Admit Patient</th>
                 ...
                 <tr className='text-sm' key={index}>
                    ...
                    <td className="px-3 py-2">
                     ...
                     <td className="px-3 py-2 flex justify-center align-middle">
						{!app.completed && <button type="button" 
