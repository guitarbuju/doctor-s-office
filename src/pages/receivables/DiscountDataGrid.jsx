...
useEffect(() => {
    // Check if foundPatient has the necessary data
    if (foundPatient?.data?.data.length > 0) {
        // If yes, set admission_id to the first admission_id in the data
        setDataToApi((prevState) => ({
            ...prevState,
            admission_id: foundPatient.data.data[0].admission_id
        }));
    }
}, [foundPatient]);
